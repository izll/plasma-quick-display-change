...
KCM.SimpleKCM {
    ...
    Kirigami.FormLayout {
        ...
        QQC2.CheckBox {
            ...
            Kirigami.FormData.label: tr("Show monitor count badge")
            checked: cfg_showBadge
            onToggled: cfg_showBadge = checked
        }
        ...
        QQC2.Label {
            text: tr("Note: Changes will take effect after restarting the widget or Plasma shell.")
